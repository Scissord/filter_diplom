export function drawChain7(n, R1, R2) {
	...
	if(N == 7 && r1 > r2){
		...
		var Rout = createRectangle(395, 65, 30, 40, 'Rout');
		...
		var link = createLink(Rout, hiddenCircleUp6);

		var link = createLink(hiddenCircleUp5, hiddenCircleUp6);
		...
		var Rout = createRectangle(400, 65, 30, 40, 'Rout');
