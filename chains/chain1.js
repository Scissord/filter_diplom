export function drawChain(n, R1, R2) {
	...
	if(N == 1 && r1 > r2){
		...
		var capacitor = createCapacitor(105, 70, 20, 10);
		
		var Rout = createRectangle(155, 65, 30, 40, 'Rout');

		var hiddenCircleUpRight = createCircle(170, 20);
		var hiddenCircleMiddle = createCircle(115, 20);
		var hiddenCircleDownMiddle = createCircle(115, 150);
		var hiddenCircleDownRight = createCircle(170, 150);

		var link = createLink(Rin, hiddenCircleMiddle);
		
		var link = createLink(hiddenCircleMiddle, capacitor);

		var link = createLink(hiddenCircleMiddle, hiddenCircleUpRight);
		...
		var link = createLink(capacitor, hiddenCircleDownMiddle);
		...
		var link = createLink(hiddenCircleMiddle, hiddenCircleL1Start);
		...
		var link = createLink(hiddenCircleDown, hiddenCircleDownRight);
	}
